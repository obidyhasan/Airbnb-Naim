...
const Footer = () => {
  return (
    <footer className="w-full bg-[#FCFCFC] border-t border-muted mt-3">
      <div className="max-w-[1920px] mx-auto px-6 lg:px-12 pt-12">
        <h1 className="text-2xl font-bold">Inspiration for future getaways</h1>
        <div className="my-3">
          <Tabs defaultValue="tips" className="w-full">
            <div className="w-full border-b flex flex-wrap">
              <TabsList className="bg-transparent p-0 gap-4 my-1 flex flex-col items-start pb-6 mt-5">
                <TabsTrigger
                  value="tips"
            ...
            <TabsContent value="tips" className="mt-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 xl:grid-cols-6 gap-2 space-y-4">
            ...
            <TabsContent value="apartments" className="mt-4">
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 xl:grid-cols-6 gap-2 space-y-4">
